...
import SimpleComponent from "./forHW/simpleComponent";
import withFunctions from "./forHW/withFunctions";

const HocExercise = () => {
    const ComponentWithFunction = withFunctions(SimpleComponent);
    return (
